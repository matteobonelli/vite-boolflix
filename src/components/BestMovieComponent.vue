<template>
    <div class="container mb-5">
        <div class="d-flex justify-content-between align-items-center ">
            <div>
                <h2 class="text-light display-5 fw-bold mb-3" v-if="store.bestMovies">Migliori Film</h2>
        ...
        <div class="d-flex overflow-hidden" ref="movieScroller">
            <PostersComponent v-for="movie in store.popularMovies" @click="getActorsMovies(movie)"
